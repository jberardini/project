  html = (
               '<div class="window-content">' +
                   ...
                   "<img src=/static/img/like-1.png id=favorite onClick='{onClick(" + key + ")}'>" +
               '</div>');
...
<!-- <h2>Welcome to {{ user.neighborhood }}</h2>
<div>Your Favorite Places</div>

{% for place in user.fav_places %}
<ul>
    <li>place.name</li>>
</ul>
{% endfor %}
